...
ActiveRecord::Schema.define(version: 2018_06_10_045135) do
  ...
  create_table "gtid_executed", primary_key: ["source_uuid", "interval_start"], options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
  ...
  create_table "ndb_binlog_index", primary_key: ["epoch", "orig_server_id", "orig_epoch"], options: "ENGINE=MyISAM DEFAULT CHARSET=utf8", force: :cascade do |t|
